...
Twenty-one of twenty-four predictions are confirmed across one-shot
matrix games, fixed-point NE search, iterated games (Kim et al.\ 2021),
and nine AI safety applications. The cooperation theorem holds at
100\% across 2,000 random games. The corrigibility game achieves
100\% safe equilibrium selection. The alignment tax is zero in 4/5 games.
$\Omega$-PG learns state-dependent trust policies that detect
mesa-optimiser defection patterns.
