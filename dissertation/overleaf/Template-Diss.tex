...
\begin{dissertationsummary}
  ...
  Dissertation can be found in the \textit{Instructions and Guidelines for
    the Dissertation in Applicable Mathematics}.
    % ~\cite{IandG1718}.
...
Here we give some sample references.

\cite{munkres1} is an excellent textbook on algebraic topology.
An important theorem in topology is Sperner's lemma
\citep[Theorem~1]{sperner}.

An article in an edited volume is \cite{BrownvonN1950}.
The paper \cite{ivanov2009} is an arXiv preprint.

The webpage
\url{http://merkel.texture.rocks/Latex/natbib.php} 
shows how to use the \texttt{natbib} package.
