...
The optional MLP-policy IPD check in \cref{app:mlp} can be regenerated with:
{\scriptsize
\begin{verbatim}
...
This script requires PyTorch and uses DiCE-style surrogate losses for the higher-order terms. The aggregate results used in the appendix are stored in \texttt{artifacts/mlp/mlp\_ipd\_results.csv}.
